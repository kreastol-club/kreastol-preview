...
ActiveRecord::Schema[7.0].define(version: 2023_03_20_140844) do
  ...
  create_table "event_templates", force: :cascade do |t|
    ...
    t.integer "minute"
    t.integer "place_id"
    t.index ["place_id"], name: "index_event_templates_on_place_id"
  end
  ...
  add_foreign_key "event_templates", "places"
